...
\begin{figure}[t]
  ...
  \caption{Clean end-to-end PDR at $2\times$ hotspot for the four non-GNN variants across three independent training seeds (points), with three-seed mean $\pm$ s.d.\ (bars). The centralised family (blue) separates from the local family (orange) in every seed; the two value heads within each family overlap. Dashed line: the policy-independent worst-path floor ($65.8\%$), identical across seeds.}
  \label{fig:seedvar}
\end{figure}
